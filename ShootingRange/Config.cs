...
namespace ShootingRange
{
    public class Config : IConfig
    {
        ...
        [Description("Determines whether players with Remote Admin access are immune to the shooting range bounds (default is false)")]
        public bool RaBoundsImmunity { get; set; } = false;
        ...
        public bool RangersCanTalk { get; set; } = true;
        [Description("Determines whether debug logs will be shown.")]
